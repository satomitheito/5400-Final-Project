...
if __name__ == "__main__":
    ...
    try:
        ...
        if 'compound' in sentiment_df.columns:
            sentiment_df['original_compound'] = sentiment_df['compound']
            sentiment_df = sentiment_df.drop(columns=['compound'])
        else:
        ...
        if 'compound' in t_sentiment_df.columns:
            ...
            t_sentiment_df = t_sentiment_df.drop(columns=['compound'])
        else:
