...
An interesting question to raise when looking at our Japanese news articles is: If we were to use translated text, would the sentiment 

Thus, to investigate this question, we translated our Japanese articles to English using *Hugging Face*. Afterwards, the translated text was saved as a separate column in the data set. 
